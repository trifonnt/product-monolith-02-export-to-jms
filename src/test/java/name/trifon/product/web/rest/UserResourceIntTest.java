...
import name.trifon.product.web.rest.errors.ExceptionTranslator;
...
public class UserResourceIntTest {
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userRepository, mailService, userService, userSearchRepository, jacksonMessageConverter);
