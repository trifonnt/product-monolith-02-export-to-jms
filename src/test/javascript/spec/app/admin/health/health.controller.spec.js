...
describe('Controller Tests', function () {
    ...
    describe('JhipHealthCheckController', function () {
        var $scope, jhiHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, JhipHealthService) {
            $scope = $injector.get('$rootScope').$new();
            jhiHealthService = JhipHealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('JhipHealthCheckController as vm', locals);
            };
            createController();
        }));
