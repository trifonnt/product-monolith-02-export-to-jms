(function() {
    ...
    angular
        .module('productApp')
        .factory('JhipTrackerService', JhipTrackerService);

    JhipTrackerService.$inject = ['$rootScope', '$window', '$cookies', '$http', '$q'];

    function JhipTrackerService ($rootScope, $window, $cookies, $http, $q) {
