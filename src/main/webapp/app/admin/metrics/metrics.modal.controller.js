(function() {
    ...
    angular
        .module('productApp')
        .controller('JhipMetricsMonitoringModalController', JhipMetricsMonitoringModalController);

    JhipMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function JhipMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
