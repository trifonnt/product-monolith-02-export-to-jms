...
//		this.jacksonObjectMapper = jacksonObjectMapper; // @Trifon
		this.jacksonMessageConverter = jacksonMessageConverter; // @Trifon
	}
    ...
    public ResponseEntity<UserDTO> updateUser(@RequestBody ManagedUserVM managedUserVM) {
		...
		try {
//			log.debug("TRIFON - userDTO: {}", jacksonObjectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(updatedUser.get()));
			log.debug("TRIFON   userDTO: {}", jacksonMessageConverter.getObjectMapper().writeValueAsString(updatedUser.get()));
