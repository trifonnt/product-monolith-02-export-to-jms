package name.trifon.product.web.websocket;

import name.trifon.product.security.SecurityUtils;
import name.trifon.product.web.websocket.dto.ActivityDTO;
...
import static name.trifon.product.config.WebsocketConfiguration.IP_ADDRESS;
